        ...
        Other = {
            xmpl_daronne_grand_feast = {
                ...
                text = {
                    ...
                    'buffs by {X:dark_edition,C:white} ^2 {}',
                    ...
                    'becomes {C:dark_edition}Polychrome{} and {C:cry_exotic}Absolute{},',
                    'and gains {C:attention}+3{} consumables per reroll',
        ...
        Joker = {
            ...
            j_xmpl_daronne_vexpi = {
                ...
                text = {
                    ...
                    '{C:red,E:2}Self-destructs{} after {C:attention}3{} underfed hands',
                    ...
                    'Eating an {C:eternal}Eternal{} Joker gives {C:money}+$50{} immediately',
                    'If {C:attention}10+{} consumables are present,',
                    'all {C:attention}Jokers{} in the shop are {C:dark_edition}Negative{}',
                    'Eaten {C:dark_edition}Negative{} Jokers give {C:money}+$4/$6/$8/$10{}',
